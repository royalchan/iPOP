...
my @files = ("Nimblegen_All_UNK_Log2_QN_lm_id.txt");
my @outfiles = ("Nimblegen_All_UNK_Log2_QN_lm_id_refpsn.txt", "Nimblegen_All_UNK_Log2_QN_lm_id_ref.txt", "Nimblegen_All_UNK_Log2_QN_lm_id_psn.txt");
open(IN, "$files[0]") || die;
