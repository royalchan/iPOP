...
open(IN, "UNK_RNASVA_AllHits_Spearman_RhoSquared.txt") || die "Cannot open the input file!!\n\n";
open(OUT, "> UNK_RNASVA_AllHits_Spearman_RhoSquared_CytoscapeInput.txt");
...
open(IN, "UNK_RNASVA_AllHits_Spearman_Rho.txt") || die "Cannot open the input file!!\n\n";
open(OUT, "> UNK_RNASVA_AllHits_Spearman_Rho_CytoscapeInput.txt");
